...
fun DerivedStateOfDemo(modifier: Modifier = Modifier) {
    ...
    /*
        Used for frequently changing outcoming state
        used when the condition value (here boolean) changes less often than the key
     */
    val showScrollToTopButton by remember {
        derivedStateOf {
            //state changes everytime after the list is greater than 10
