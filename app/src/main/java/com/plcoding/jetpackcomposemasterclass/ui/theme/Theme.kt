...
/*
    There is no clear rules how you transform non material theme colors into Android theme.
    Most of the time you don't need to make use of all the colors in your app that material theme provides
    Commonly an app will use following colors
        - background, onBackground,
        - surface, onSurface
        - outline(for borders), onOutline,
        - primary(most visible), onPrimary
        - secondary(2nd most visible), onSecondary
        - error, onError

 */
@Immutable
data class ExtendedColorScheme(
    //Custom colors we can additionally select in the above website
...
@Composable
//Make sure to rename this this from the default to your projectname theme
fun JetpackComposeMasterclassTheme(
    darkTheme: Boolean = isSystemInDarkTheme(),
    // Dynamic color is available on Android 12+
    //It sets the color based on user's wallpaper
    dynamicColor: Boolean = false, //false to test our own theme
    content: @Composable() () -> Unit
) {
    val colorScheme = when {
        //dynamic color conditionally applied to Android 12+ versions and above
